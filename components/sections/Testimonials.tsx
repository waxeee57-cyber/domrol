          ...
          >
            {TESTIMONIALS.map((t) => (
              ...
              >
                {/* Quote */}
                <p
                  className="quote-text font-display text-mist"
                  style={{
                    fontSize: '1.2rem',
                    fontWeight: 300,
                ...
                >
                  {/* Avatar */}
                  <div
                    className="font-mono text-dust flex items-center justify-center shrink-0"
                    style={{
                      width: '32px',
                      height: '32px',
                      borderRadius: '50%',
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-body text-paper" style={{ fontSize: '13px', fontWeight: 500 }}>
                      {t.name}
                    </div>
                    <div
                  ...
                  {/* Stars */}
                  <div
                    className="text-rental shrink-0"
